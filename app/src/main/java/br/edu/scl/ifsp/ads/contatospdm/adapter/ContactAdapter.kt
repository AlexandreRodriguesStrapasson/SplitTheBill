...
class ContactAdapter(context: Context, private val contactList: MutableList<Contact>):
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if(contactTileView == null) {
            ...
            val tileContactHolder = TileContactHolder(tcb.nameTv, tcb.pagarReceberTv)
    ...
    private data class TileContactHolder(val nameTv: TextView, val pagarReceberTv: TextView)
}